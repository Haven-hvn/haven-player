            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: 2 }}>
              ...
              <FormControl fullWidth size="small">
                ...
                <FormHelperText>
                  ...
                  {newJob.on_success === 'archive_all' && 'Automatically download all discovered videos. Failed downloads will be retried on the next run.'}
                  {newJob.on_success === 'archive_new' && 'Download newly discovered videos. Failed downloads will be retried on the next run, successful ones are marked as seen.'}
                </FormHelperText>
              </FormControl>
            </Box>
